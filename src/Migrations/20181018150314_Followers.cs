        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Recepies_AspNetUsers_IdentityId",
                        column: x => x.IdentityId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRecpieVotes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserRecpieVotes_AspNetUsers_IdentityId",
                        column: x => x.IdentityId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ingridients_Recepies_RecepieId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ingridients_RecepieId",
                table: "Ingridients",
                column: "RecepieId");

            migrationBuilder.CreateIndex(
                name: "IX_Recepies_IdentityId",
                table: "Recepies",
                column: "IdentityId");
